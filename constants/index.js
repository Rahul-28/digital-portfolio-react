...
const allExperiences = [
  {
    ...
    locationType: 'Remote',
    description:
      'Built responsive web apps using Angular and TypeScript, with Tailwind CSS for fast, modern UI styling. '
  },
  {
    id: 2,
    ...
    locationType: 'Remote',
    description:
      'Contributed to Ionic, an open-source project by writing code, fixing bugs, and adding tests, thus improving reliability.'
  },
  {
    id: 3,
    ...
    locationType: 'Onsite',
    description:
      'Currently working as an Assistant System Engineer at TCS, also focusing on full-stack development and devops'
  }
];

const gmail = 'rahulrajeshrr365@gmail.com';
const resumeLink =
  'https://ugc.production.linktr.ee/01f59c4b-0bb7-477b-af2b-1edac0585b1b_rahul-resume-v1.pdf';
