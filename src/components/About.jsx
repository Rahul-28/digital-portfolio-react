      ...
      <div className="mb-16 md:px-0 px-5">
        <div className="content">
          <div className="md:col-span-8">
            <a href={resumeLink} className="badge" target="_blank">
              My Resume
            </a>
            <h2>Passion for creativity - driven by curiosity</h2>
          </div>
          <div className="sub-content">
            <p className="about-content-1">
              Hi! I’m {fullName}, a dedicated web developer with a keen eye for design and a passion
              for building intuitive, accessible digital experiences. Having worked on projects
              across multiple domains, I thrive on transforming ideas into polished, user-friendly
              realities.
            </p>
            <p className="about-content-2">
              Always curious and creative—whether coding, exploring new tech, or finding inspiration
              outside the screen.
            </p>
          </div>
        </div>
